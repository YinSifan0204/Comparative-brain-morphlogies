...
print('Compare Three shape index_ferret_left_scatter.tif','-dtiff')
...
set(0,'defaultaxesfontsize',22);
print('Compare Three meancurv_ferret_left_scatter.tif','-dtiff')
...
figure(1) 
set(gcf,'position',[50,50,1000,800])
plot_meshp_lm(v3,f3,lm3,threshold(mean_curv3,0.75));
%title([lr{i},' real ferret brain'])
view([0 10])  
...
%plot_meshg_lm(v3,f3,lm3,threshold0(mean_curv3,0.75));
%title([lr{i},' real ferret brain'])
view([0 10])  
caxis([-1,1])
...
fid = fopen('Similarity_ShapeIndex_ferret_Three0426.txt','a+')
fprintf(fid,name)
fprintf(fid,'\r\n')
fprintf(fid,'\t')
...
fid = fopen('Similarity_rescaled_meancurv_ferret_Three0426.txt','a+')
fprintf(fid,name)
fprintf(fid,'\r\n')
fprintf(fid,'\t')
fprintf(fid,'simu_p1=%8.4f, gel_p1=%8.4f\r\n',score13_p1,score23_p1)
...
score13_p3 = 1 - ( sum(abs(I1-I3).^3)/length(I1)).^(1/3)
...
score23_p3 = 1 - ( sum(abs(I2-I3).^3)/length(I2) ).^(1/3)

score23_pinf = 1 - max(abs(I2-I3)/length(I2))



fid = fopen('Similarity_binary_meancurv_ferret0314.txt','a+')
fprintf(fid,name)
fprintf(fid,'\r\n')
